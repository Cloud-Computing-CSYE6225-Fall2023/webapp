...
func main() {
	...
	// Assignments Routes
	router.Handle("/v3/assignments", middleware.NewBasicAuth(ctx, assignmentHandler.Get, accntSvc)).Methods("GET")
	router.Handle("/v3/assignments", middleware.NewBasicAuth(ctx, assignmentHandler.Insert, accntSvc)).Methods("POST")
	router.Handle("/v3/assignments/{id}", middleware.NewBasicAuth(ctx, assignmentHandler.GetById, accntSvc)).Methods("GET")
	router.Handle("/v3/assignments/{id}", middleware.NewBasicAuth(ctx, assignmentHandler.Modify, accntSvc)).Methods("PUT")
	router.Handle("/v3/assignments/{id}", middleware.NewBasicAuth(ctx, assignmentHandler.Delete, accntSvc)).Methods("DELETE")
	router.Handle("/v3/assignments/{id}/submission", middleware.NewBasicAuth(ctx, assignmentHandler.PostAssignmentSubmission, accntSvc)).Methods("POST")
