...
func main() {
	msg := flag.String("m", "hi", "The message to send to the subscribed users of the topic")
	topicARN := flag.String("t", "arn:aws:sns:us-east-1:394598842451:test.fifo", "The ARN of the topic to which the user subscribes")
